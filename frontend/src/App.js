...
import ListaHorasUsuarioComponent from './components/ListaHorasUsuarioComponent';
function App() {
  return (
    <div>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/perfil_usuario" element = {<PerfilUsuarioComponent/>}/>
        <Route path="/mis_horas" element = {<ListaHorasUsuarioComponent/>}/>
      </Routes>
    </BrowserRouter>
