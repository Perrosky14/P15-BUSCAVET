import { Box, Button, IconButton, Modal, ThemeProvider, Typography } from '@mui/material';
...
const DeleteConfirmationMascotaComponent = ({ open, handleClose, handleConfirm }) => {
    return (
            ...
            >
                <Box sx={styles.modalBox}>
                    ...
                    <Typography id="modal-title" variant="h6" component="h2" sx={styles.typography}>
                        ¿Está seguro que desea eliminar a esta mascota?
                    </Typography>
...
export default DeleteConfirmationMascotaComponent;