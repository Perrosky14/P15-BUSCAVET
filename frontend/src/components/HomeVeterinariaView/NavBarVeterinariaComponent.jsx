...
import { Settings, MonitorHeart, CalendarMonth, MarkEmailRead, BarChart, ExitToApp, LocalHospital } from "@mui/icons-material";
    ...
    return (
        <DrawerStyled variant="permanent">
            ...
            <List>
                ...
                <ListItemStyled button component="a" href="/veterinaria/doctores">
                    <ListItemIconStyled><LocalHospital /></ListItemIconStyled>
                    <ListItemTextStyled primary="Mis Doctores" />
                </ListItemStyled>
